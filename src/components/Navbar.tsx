...
import { LogOut, ShieldAlert, Bell, Key, House } from 'lucide-react';
        ...
        {currentUser && (
          <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
            ...
            {currentUser.role === 'admin' && (
              <Link to="/admin" className="btn-secondary" style={{ padding: '0.5rem 1rem', fontSize: '0.9rem', gap: '0.5rem' }}>
                <ShieldAlert size={16} />
                لوحة التحكم
              </Link>
            )}
            ...
            <div style={{ position: 'relative' }}>
              ...
              {showNotifications && (
                <div style={{ position: 'absolute', top: '100%', left: 0, width: '300px', background: 'var(--bg-card)', border: '1px solid var(--border-color)', borderRadius: '12px', padding: '1rem', boxShadow: '0 10px 25px rgba(0,0,0,0.5)', zIndex: 1000, marginTop: '0.5rem' }}>
